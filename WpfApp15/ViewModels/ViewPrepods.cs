...
namespace WpfApp15.ViewModels
{
    public class ViewPrepodsVM : BaseVM
    {
        ...
        public int SelectedIndex
        {
            ...
            {
                selectedIndex = value;
                Prepods = SqlModel.GetInstance().SelectPrepodsRange((selectedIndex - 1) * ViewRowsCount, ViewRowsCount);
                Signal();
            }
        }
        ...
        private void InitPages()
        {
            ...
            int pageCount = (sqlModel.GetNumRows(typeof(Prepods)) / ViewRowsCount) + 1;
