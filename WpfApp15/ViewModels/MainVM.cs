...
namespace WpfApp15.ViewModels
{
    class MainVM : BaseVM
    {
        ...
        public CommandVM CreatePrepods { get; set; }
        ...
        public MainVM()
        {
            ...
            CreatePrepods = new CommandVM(() => {
                currentPageControl.SetPage(new EditPrepodsPage(new EditPrepodsVM(currentPageControl)));
            });
            ...
            ViewCurator = new CommandVM(() => {
                currentPageControl.SetPage(new ViewCuratorPage(null));
            });
